<x-guest-layout>
    ...
    <form method="POST" action="{{ route('transfer.create') }}">
        ...
        <div>
            ...
            <x-text-input id="destinoConta" class="block mt-1 w-full" type="text" name="destinoConta" required autofocus />
        ...
        <div class="mt-4 hidden">
            ...
            <x-text-input id="descricao" class="block mt-1 w-full" type="hidden" name="descricao" required value="Transferência" />
